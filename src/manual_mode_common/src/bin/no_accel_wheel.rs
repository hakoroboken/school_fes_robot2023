...
fn main() -> Result<(), DynError> {
    ...
    let param_no_accel_power = get_f64_parameter(node.get_name(), "power", 0.15) as f32;
    ...
    selector.add_subscriber(
        ...
        Box::new(move |msg| {
            ...
            send_msg.vec_x = msg.get_value(param_x_name.as_str()) * param_no_accel_power;
            send_msg.vec_y = msg.get_value(param_y_name.as_str()) * param_no_accel_power;
            send_msg.rotation_power = msg.get_value(param_rotation_name.as_str()) * param_no_accel_power;
